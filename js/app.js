$(window).on('load', function () {
    ...
    var player1Name; //Initialisation nom du joueur 1
    var player2Name; //Initialisation nom du joueur 2
    var gameboardCases; //Initialisation du tableau des cases du plateau de jeu
    var sound = false; //Initialisation interrupteur Sons, sur Off par défaut
    var music = false; //Initialisation interrupteur Musique, sur Off par défaut
    var currentMusic; //Initialisation musique en cours
    ...
    class Player { //DECLARATION CLASSE DU JOUEUR
        ...
        unDraw() { //METHODE SUPPRESSION IMAGE DU JOUEUR ET SON CHEMIN
    ...
    function game(player) {//FONCTION PRINCIPALE LANCANT LE TOUR DU JOUEUR
        player.lookAround();
    ...
    function looseGame(looserId, looserName, winnerName) { //INTERFACE LORS DE LA DEFAITE D'UN JOUEUR
